...
export const LoginView: React.FC<LoginViewProps> = ({ onLogin, isLoggingIn, loginStep }) => {
  ...
  if (isLoggingIn) {
    return (
      <div className="flex flex-col h-screen items-center justify-center p-6 space-y-8 animate-in fade-in duration-500">
        ...
        <div className="text-center space-y-2 max-w-[280px]">
          ...
          <p className="text-sm text-secondary font-mono h-6 px-4">{loginStep}</p>
        </div>
  ...
  return (
    <div className="flex flex-col h-screen px-4 pt-12 pb-8 justify-between relative overflow-hidden">
      {/* Background Decor */}
      ...
      <div className="space-y-6 relative z-10">
        ...
        <div>
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tighter mb-4 text-white leading-tight">
      ...
      <div className="space-y-3 relative z-10">
        {!configured && (
             <div className="bg-yellow-500/10 border border-yellow-500/20 p-3 rounded-xl flex gap-3 items-start mb-4">
        ...
        <button 
          ...
          className="w-full h-14 bg-white hover:bg-neutral-200 text-black rounded-xl font-medium flex items-center justify-center gap-3 transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation"
        >
        ...
        <button 
          ...
          disabled={isLoggingIn}
          className="w-full h-14 bg-surface border border-border hover:bg-neutral-800 text-white rounded-xl font-medium flex items-center justify-center gap-3 transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation"
        >
        ...
        <p className="text-center text-[10px] text-secondary mt-6 max-w-xs mx-auto leading-normal px-2">
